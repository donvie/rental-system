  ...
  before: {
    ...
    create: [
      async function (context) {
        ...
        try {
          const equipmentIdToUpdate = context.params.headers.id;
          await context.app.service("equipments").patch(equipmentIdToUpdate, {
    ...
    update: [
      async function (context) {
        try {
          ...
          const equipmentIdToUpdate = context.params.headers.id;
          console.log("equipmentIdToUpdate:", equipmentIdToUpdate);
          ...
          if (Array.isArray(context.params.files) && context.params.files.length > 0) {
            ...
            const result = await context.app.service("equipments").patch(
              equipmentIdToUpdate,
              {
                imagePath: context.params.files[0].path,
              }
